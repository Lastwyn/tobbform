...
namespace tobbform
{
    public partial class GyumolcsUpdate : Form
    {
        Database database = new Database();
        public GyumolcsUpdate()
        {
            InitializeComponent();
        }

        public void FormGyumolcsUpdate_Load(object sender, EventArgs e)
        {
        ...
        private void GyumolcsUpdate_Load(object sender, EventArgs e)
        {
